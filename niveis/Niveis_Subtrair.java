...
public class Niveis_Subtrair { // classe Niveis Subtrair
    public void Menu_Niveis_Subtrair(){ // metodo Menu Niveis Subtrair 
        String vetor_Niveis_Subtrair[] = new String[0x3]; // vetor dos niveis
        ...
        // definindo os níveis para operação subtrair
        vetor_Niveis_Subtrair[0] = " || 01 - Facil     ||";
        vetor_Niveis_Subtrair[1] = " || 02 - Medio     ||";
        vetor_Niveis_Subtrair[2] = " || 03 - Dificil   ||";
        
        System.out.println(" ____________________ ");
                // definindo comando para exibir os niveis
                for (int i = 0; i < 3; i++) {
                    System.out.println(vetor_Niveis_Subtrair[i]);
                }
                System.out.println(" ____________________ ");
        
                System.out.println(" Escolha o nível para Subtrair : ");
                esc = sc.nextInt();
