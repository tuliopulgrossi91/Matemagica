...
public class Niveis_Somar { // classe Niveis Somar
    public void Menu_Niveis_Somar(){ // metodo Menu Niveis Somar 
        String vetor_Niveis_Somar[] = new String[0x3]; // vetor dos niveis
        ...
        // definindo os níveis para operação somar
        vetor_Niveis_Somar[0] = " || 01 - Facil     ||";
        vetor_Niveis_Somar[1] = " || 02 - Medio     ||";
        vetor_Niveis_Somar[2] = " || 03 - Dificil   ||";
        
        System.out.println(" ____________________ ");
                // definindo comando para exibir os niveis
                for (int i = 0; i < 3; i++) {
                    System.out.println(vetor_Niveis_Somar[i]);
                }
                System.out.println(" ____________________ ");

                System.out.println();
                System.out.print(" Escolha o nível para Somar : ");
                esc = sc.nextInt();
